...
🔹 وظيفة الملف:
عمل نسخ معدلة من الصور (تشويش، تغيير بسيط)، مفيد لزيادة حجم البيانات (Augmentation)
خاصة إذا كان لديك عدد قليل من الصور.

🔧 أهم المتغيرات:
- input_folder = "Indecent" → مجلد الصور الأصلية.
- output_folder = "Augmented_Decent" → تأكد من إنشاء المجلد قبل التشغيل.

💡 يُستخدم لتحسين أداء النموذج عبر تنويع البيانات.
"""
